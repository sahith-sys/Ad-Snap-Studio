...
function ProductEditing() {
    ...
    async function generatePackshot(){
        ...
        setLoading(true);
        try {
           const response = await axios.post("http://localhost:5000/features/product-packshot", {
            file: userImage,
            bg_color: "#FFFFFF"
           });
    ...
    <div className="flex flex-col items-center justify-center text-center min-h-[200px] mt-25 p-4">
          ...
          <div className="my-15 flex gap-35 flex-wrap justify-center">
            ...
            <div>
              ...
              <img
                src={preview ? preview : "https://bria.ai/hs-fs/hubfs/BRIA_LP_Ecommers_new-03-1.png?width=846&height=375&name=BRIA_LP_Ecommers_new-03-1.png"}
                alt="Preview"
            ...
            <div>
              ...
              {loading ? (
                ...
                <img
                  src={resultImageLoaded ? resultImage : "https://bria.ai/hs-fs/hubfs/BRIA_LP_Ecommers_new-03-1.png?width=846&height=375&name=BRIA_LP_Ecommers_new-03-1.png"}
